...
# # # variables for indeed search
    ...
    for i in soup.select("div.jobsearch-SerpJobCard > h2.title > a"):
        print("inside theea")
    ...
    for i in url2:
        try:
         ...
         #   print(companynamedb)
            jobtitledb=""
            try:
                for j in soup1.select("h1.icl-u-xs-mb--xs.icl-u-xs-mt--none.jobsearch-JobInfoHeader-title"):
                    jobtitledb=j.text
                    #print(jobtitledb)
            except:
                jobtitledb="jobtitle not defined"
            print("job title yaja hai")
            print(jobtitledb)
...
# # # #
    ...
    for i in url2:
        ...
        #    continue
            ...
            try:
                jobtitledb = soup1.select("h2.topcard__title")[0].text
            except:
